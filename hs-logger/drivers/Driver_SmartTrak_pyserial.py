...
# testing
def main():
    instr = Driver_SmartTrak_pyserial(json.load(open('SmartTrak100.json')))
    #instr.write_instrument('write_Valve_index', 1)
    #print(instr.read_instrument('read_Tm'))
    print(instr.read_instrument('read_stream_mode'))
    instr.write_instrument('write_stream_mode','OFF')
    print(instr.read_instrument('read_stream_mode'))
    instr.write_instrument('write_flow',0.3)
    print(instr.read_instrument('read_flow'))

    #instr.write_instrument('write_Valve_index', 2)
