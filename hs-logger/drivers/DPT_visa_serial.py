            ...
            if dtype == 'read_store':
                ...
                with self.lock:
                    ...
                    try:
                        ...
                        pass
                    splits = re.split(r'\s+', data)  # RegEx for 1 or more whitespace chars.
                    if splits[0] == "":
                        splits = splits[1:]
                    data = []
                    for val in splits:
...
# testing
def main():
    instr = DPT_visa_serial(json.load(open('../instruments/Vaisala_HMT337.json')))
