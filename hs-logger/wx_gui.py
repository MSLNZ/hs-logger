...
class job_frame(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"<job_name>", pos=wx.DefaultPosition,
                          size=wx.Size(702, 431), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
        ...
        self.move_to = wx.Button(self.auto_profile, wx.ID_ANY, u"Move to Selected", wx.DefaultPosition, wx.DefaultSize,
                                 0)
        ...
        self.assured_error_text = wx.StaticText(self.auto_profile, wx.ID_ANY, u"Error <", wx.DefaultPosition,
                                                wx.DefaultSize, 0)
        self.assured_error_text.Wrap(-1)
        self.assured_error_text.SetFont(
        ...
        self.assured_error_input = wx.TextCtrl(self.auto_profile, wx.ID_ANY, u"0.1", wx.DefaultPosition,
                                               wx.Size(40, -1), 0)
        ...
        self.assured_stdev_text = wx.StaticText(self.auto_profile, wx.ID_ANY, u"StDev <", wx.DefaultPosition,
                                                wx.DefaultSize, 0)
        self.assured_stdev_text.Wrap(-1)
        self.assured_stdev_text.SetFont(
            wx.Font(wx.NORMAL_FONT.GetPointSize(), wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL,
                    False, wx.EmptyString))

        bSizer392.Add(self.assured_stdev_text, 0, wx.ALL | wx.ALIGN_CENTER_VERTICAL, 5)

        self.assured_stdev_input = wx.TextCtrl(self.auto_profile, wx.ID_ANY, u"0.1", wx.DefaultPosition,
                                               wx.Size(40, -1), 0)
...
class add_graph_dialog(wx.Dialog):
    ...
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=wx.EmptyString, pos=wx.DefaultPosition,
                           size=wx.Size(700, 190), style=wx.DEFAULT_DIALOG_STYLE)
...
class append_graph_dialog(wx.Dialog):
    ...
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=wx.EmptyString, pos=wx.DefaultPosition,
                           size=wx.Size(288, 185), style=wx.DEFAULT_DIALOG_STYLE)
...
class detract_graph_graph_dialog(wx.Dialog):
    ...
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=wx.EmptyString, pos=wx.DefaultPosition,
                           size=wx.Size(288, 131), style=wx.DEFAULT_DIALOG_STYLE)
...
class remove_graph_dialog(wx.Dialog):
    ...
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=wx.EmptyString, pos=wx.DefaultPosition,
                           size=wx.Size(288, 125), style=wx.DEFAULT_DIALOG_STYLE)
...
class new_action_autoprofile_dlg(wx.Dialog):
    ...
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=wx.EmptyString, pos=wx.DefaultPosition,
                           size=wx.Size(289, 232), style=wx.DEFAULT_DIALOG_STYLE)
        ...
        self.m_staticText114 = wx.StaticText(self, wx.ID_ANY, u"Instrument", wx.DefaultPosition, wx.DefaultSize,
                                             wx.ALIGN_RIGHT)
        ...
        self.m_staticText111 = wx.StaticText(self, wx.ID_ANY, u"Set", wx.DefaultPosition, wx.DefaultSize,
                                             wx.ALIGN_RIGHT)
        ...
        self.m_staticText113 = wx.StaticText(self, wx.ID_ANY, u"Check", wx.DefaultPosition, wx.DefaultSize,
                                             wx.ALIGN_RIGHT)
        ...
        self.m_staticText112 = wx.StaticText(self, wx.ID_ANY, u"Read", wx.DefaultPosition, wx.DefaultSize,
                                             wx.ALIGN_RIGHT)
...
class inst_pannel(wx.Frame):
    ...
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"<instrument>", pos=wx.DefaultPosition,
                          size=wx.Size(515, 253), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
